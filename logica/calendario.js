...
if(localStorage.getItem('calendarioLocal')==null){
	var misHorarios=`{"0":{"0":["-------","-------","Ocupado","Ocupado"],"1":["-------","-------","-------","-------"],"2":["-------","-------","Ocupado","Ocupado"]},"1":{"0":["-------","-------","-------","-------"],"1":["-------","-------","-------","-------"],"2":["-------","-------","-------","-------"]},"2":{"0":["-------","-------","-------","-------"],"1":["Ocupado","Ocupado","-------","-------"],"2":["Ocupado","Ocupado","-------","-------"]},"3":{"0":["-------","-------","-------","-------"],"1":["-------","-------","-------","-------"],"2":["-------","-------","-------","-------"]},"4":{"0":["-------","-------","-------","-------"],"1":["-------","-------","-------","-------"],"2":["-------","-------","-------","-------"]},"5":{"0":["-------","-------","-------","-------"],"1":["-------","-------","-------","-------"],"2":["Ocupado","Ocupado","Ocupado","-------"]},"6":{"0":["-------","-------","-------","-------"],"1":["-------","-------","-------","-------"],"2":["-------","-------","-------","-------"]}}`
	localStorage.setItem('calendarioLocal',misHorarios);
